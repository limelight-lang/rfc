...
> ([strategies.md](strategies.md)), and the one of record is `rc-cycle`
> ([rc-cycle.md](rc-cycle.md)); `rc-walk`, `rc-trace` and the concurrent
> SATB strategy were deleted on 2026-08-26 and are on the branch
> `archive/pre-rc-cycle`; MMTK is no longer
...
(`rfc`'s `archive/pre-rc-cycle`, `model/gc/gc-horizon-v2/prior-art.md`).
