...
forbidden. This is the discipline the arena's release-at-reset list already
relies on: erring
...
enter the global marker as roots (a marker of the deleted `rc-satb`: `rfc`'s
`archive/pre-rc-cycle`, `model/gc/satb.md`),
